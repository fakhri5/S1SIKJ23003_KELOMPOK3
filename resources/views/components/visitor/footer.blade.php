<footer class="bg-gray-100" id="footer">
    <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
                <div class="flex justify-center text-green-300 sm:justify-start">
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
                <div class="text-center sm:text-left">
                    <p class="text-lg font-medium text-slate-800">About Us</p>

                    <nav class="mt-8">
                        <ul class="space-y-4 text-sm">
                            <li>
                                <a class="text-slate-700 transition hover:text-slate-700/75" href="/">
                                    Company History
                                </a>
                            </li>
                ...
                <div class="text-center sm:text-left">
                    <p class="text-lg font-medium text-slate-800">Our Services</p>

                    <nav class="mt-8">
                        <ul class="space-y-4 text-sm">
                            <li>
                                <a class="text-slate transition hover:text-slate/75" href="/">
                                    Web Development
                                </a>
                            </li>
                ...
                <div class="text-center sm:text-left">
                    <p class="text-lg font-medium text-slate-800">Helpful Links</p>
                        ...
                        <ul class="space-y-4 text-sm">
                            ...
                            <li>
                                <a class="flex group justify-center sm:justify-start gap-1.5" href="/">
                                    <span class="text-slate-700 transition group-hover:text-slate-700/75">
                                        Live Chat
                                    </span>
                ...
                <div class="text-center sm:text-left">
                    <p class="text-lg font-medium text-slate-800">Contact Us</p>

                    <ul class="mt-8 space-y-4 text-sm">
                        <li>
                            <a class="flex items-center justify-center sm:justify-start gap-1.5 group" href="/">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-slate-700 shrink-0"
                        ...
                        <li class="flex items-start justify-center gap-1.5 sm:justify-start">
                            ...
                            <address class="-mt-0.5 not-italic text-slate-700">
        ...
        <div class="pt-6 mt-12 border-t border-gray-800">
            <div class="text-center ">
                {{-- sm:flex sm:justify-between sm:text-left --}}
                {{-- <p class="text-sm text-gray-400">
                    <span class="block sm:inline">All rights reserved.</span>

                    <a class="inline-block text-green-500 underline transition hover:text-green-500/75" href="/">
                        Terms & Conditions
                    </a>
